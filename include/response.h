...
class Response {
public:
    Response(const string& data, http::StatusCode status_code, const map<string, string>& headers, bool keep_alive);
...
private:
    ...
    static constexpr auto const* HTTP_HEADER_TEMPLATE =
        "{0}: {1}\r\n";
